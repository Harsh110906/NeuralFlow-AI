...
export default function SettingsPage() {
  ...
  return (
    <div className="p-8 text-white max-w-6xl mx-auto">
      ...
      <p className="text-zinc-400 mb-8">Manage your workspace configuration and team members.</p>
      
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {sections.map(section => (
          <Link key={section.href} href={section.href} className="block border border-gray-200 dark:border-gray-800 bg-white dark:bg-zinc-950 rounded-xl p-6 hover:border-blue-500 transition-colors">
